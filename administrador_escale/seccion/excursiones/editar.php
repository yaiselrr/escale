...
if (isset($_GET['txtId'])) {
    ...
    $sentencia = $conexion->prepare("SELECT * FROM `tbl_excursiones` WHERE id = :id");
...
if ($_POST) {
    ...
    $sentencia =  $conexion->prepare("UPDATE `tbl_excursiones` SET `nombre`=:titulo,`descripcion`=:descripcion,`precio`=:precio, `enlace`=:enlace WHERE id = :id;");
    ...
    if ($foto != "") {
        ...
        move_uploaded_file($tmp_foto, "../../../images/excursiones/" . $nombre_foto);
        ...
        if (isset($registro_foto["foto"])) {
            if (file_exists("../../../images/excursiones/" . $registro_foto["foto"])) {
                unlink("../../../images/excursiones/" . $registro_foto["foto"]);
            }
        }
        $sentencia =  $conexion->prepare("UPDATE `tbl_excursiones` SET `foto`=:foto WHERE id = :id;");
    ...
    <div class="card-body">
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <img width="100" src="../../../images/excursiones/<?php echo $foto ?>" alt="Foto">
