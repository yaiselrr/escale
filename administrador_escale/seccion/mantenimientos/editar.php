...
if ($_POST) {
    ...
    $sentencia =  $conexion->prepare("UPDATE `tbl_mantenimiento` SET `nombre`=:titulo,`descripcion`=:descripcion,`precio`=:precio, `enlace`=:enlace WHERE id = :id;");
    ...
    if ($foto != "") {
        ...
        move_uploaded_file($tmp_foto, "../../../images/mantenimientos/" . $nombre_foto);
        ...
        if (isset($registro_foto["foto"])) {
            if (file_exists("../../../images/mantenimientos/" . $registro_foto["foto"])) {
                unlink("../../../images/mantenimientos/" . $registro_foto["foto"]);
            }
        }
        $sentencia =  $conexion->prepare("UPDATE `tbl_mantenimiento` SET `foto`=:foto WHERE id = :id;");
    ...
    <div class="card-body">
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <img width="100" src="../../../images/mantenimientos/<?php echo $foto ?>" alt="Foto">
