...
if ($_POST) {
    ...
    $sentencia =  $conexion->prepare("INSERT INTO `tbl_confecciones`(`id`, `nombre`, `descripcion`, `foto`, `precio`, `enlace`) VALUES (NULL, :titulo, :descripcion, :foto, :precio, :enlace);");
