...
if (isset($_GET['txtId'])) {
    ...
    $sentencia = $conexion->prepare("SELECT * FROM `tbl_confecciones` WHERE id = :id");
...
if ($_POST) {
    ...
    $sentencia =  $conexion->prepare("UPDATE `tbl_confecciones` SET `nombre`=:titulo,`descripcion`=:descripcion,`precio`=:precio, `enlace`=:enlace WHERE id = :id;");
    ...
    if ($foto != "") {
        ...
        move_uploaded_file($tmp_foto, "../../../images/confecciones-textiles/" . $nombre_foto);
        ...
        if (isset($registro_foto["foto"])) {
            if (file_exists("../../../images/confecciones-textiles/" . $registro_foto["foto"])) {
                unlink("../../../images/confecciones-textiles/" . $registro_foto["foto"]);
            }
        }
        $sentencia =  $conexion->prepare("UPDATE `tbl_confecciones` SET `foto`=:foto WHERE id = :id;");
...
<br />
<div class="card">
    <div class="card-header">Confecciones textiles</div>
    <div class="card-body">
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <img width="100" src="../../../images/confecciones-textiles/<?php echo $foto ?>" alt="Foto">
