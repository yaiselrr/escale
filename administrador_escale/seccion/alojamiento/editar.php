...
if (isset($_GET['txtId'])) {
    ...
    $sentencia = $conexion->prepare("SELECT * FROM `tbl_alojamiento` WHERE id = :id");
...
if ($_POST) {
    ...
    $sentencia =  $conexion->prepare("UPDATE `tbl_alojamiento` SET `nombre`=:titulo,`descripcion`=:descripcion,`precio`=:precio, `enlace`=:enlace WHERE id = :id;");
    ...
    if ($foto != "") {
        ...
        move_uploaded_file($tmp_foto, "../../../images/alojamiento/" . $nombre_foto);
        ...
        if (isset($registro_foto["foto"])) {
            if (file_exists("../../../images/alojamiento/" . $registro_foto["foto"])) {
                unlink("../../../images/alojamiento/" . $registro_foto["foto"]);
            }
        }
        $sentencia =  $conexion->prepare("UPDATE `tbl_alojamiento` SET `foto`=:foto WHERE id = :id;");
    ...
    <div class="card-body">
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <img width="100" src="../../../images/alojamiento/<?php echo $foto ?>" alt="Foto">
