...
if (isset($_GET['txtId'])) {
    ...
    $sentencia =  $conexion->prepare("DELETE FROM `tbl_servicios_complementarios` WHERE id = :id");
...
$sentencia = $conexion->prepare("SELECT * FROM `tbl_servicios_complementarios`");
$sentencia->execute();
                ...
                <tbody>
                    ...
                    ?>
                        <tr class="">
                            ...
                            <td><img src="../../../images/servicios/<?php echo $value['foto']; ?>" width="50" alt=""></td>
