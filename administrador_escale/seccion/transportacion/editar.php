...
if ($_POST) {
    ...
    $sentencia =  $conexion->prepare("UPDATE `tbl_transportacion` SET `nombre`=:titulo,`descripcion`=:descripcion,`precio`=:precio, `enlace`=:enlace WHERE id = :id;");
    ...
    if ($foto != "") {
        ...
        move_uploaded_file($tmp_foto, "../../../images/transportacion/" . $nombre_foto);
        ...
        $sentencia =  $conexion->prepare("UPDATE `tbl_transportacion` SET `foto`=:foto WHERE id = :id;");
...
<br />
<div class="card">
    <div class="card-header">Transportación</div>
    <div class="card-body">
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <img width="100" src="../../../images/transportacion/<?php echo $foto ?>" alt="Foto">
